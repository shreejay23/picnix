echo "\nCase 1"
curl -X POST -F "image=@../AP/PicNix/images/test/image_1.png" http://localhost:8000/upload/
...
echo "\nCase 10"
curl -X POST -F "image=@../AP/PicNix/images/test/image_59.png" http://localhost:8000/picnix/